...
export const FileUpload = ({ endpoint, onChange, value }: FileUploadProps) => {
    ...
    return (
        <UploadDropzone
            className="border-zinc-500 ut-button:bg-cyan-500 ut-button:ut-uploading:bg-cyan-500/70 after:ut-button:ut-uploading:bg-cyan-500 ut-label:text-cyan-500 hover:ut-label:text-cyan-500/70"
            endpoint={endpoint}
